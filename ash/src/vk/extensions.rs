...
#[doc = "Generated from 'VK_EXT_external_semaphore_drm_syncobj'"]
impl StructureType {
    pub const PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_DRM_SYNCOBJ_FEATURES_EXT: Self =
        Self(1_000_677_000);
}
...
pub const AMD_GPA_INTERFACE_EXTENSION_NAME: &CStr = c"VK_AMD_gpa_interface";
...
pub const QCOM_ELAPSED_TIMER_QUERY_EXTENSION_NAME: &CStr = c"VK_QCOM_elapsed_timer_query";
...
pub const QCOM_IMAGE_PROCESSING_3_EXTENSION_NAME: &CStr = c"VK_QCOM_image_processing3";
pub const QCOM_IMAGE_PROCESSING_3_SPEC_VERSION: u32 = 1u32;
pub const QCOM_SHADER_MULTIPLE_WAIT_QUEUES_EXTENSION_NAME: &CStr =
    c"VK_QCOM_shader_multiple_wait_queues";
pub const QCOM_SHADER_MULTIPLE_WAIT_QUEUES_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_SPLIT_BARRIER_EXTENSION_NAME: &CStr = c"VK_EXT_shader_split_barrier";
...
pub const KHR_OPACITY_MICROMAP_EXTENSION_NAME: &CStr = c"VK_KHR_opacity_micromap";
